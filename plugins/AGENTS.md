...
| Command | Description |
| --- | --- |
| `/cogni-ai-coder:coding` | Load the coding skill -- workflow for implementing code from clear specifications with precision |
| `/cogni-ai-coder:critical-thinking` | Load the critical-thinking skill -- a cognitive framework for deep analytical reasoning |
