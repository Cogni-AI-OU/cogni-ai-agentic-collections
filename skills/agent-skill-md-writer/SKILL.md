...
7. **Section Discipline**: Use standard sections in a logical progression:
   ...
   - `## References`:
     Links to `references/` files or external resources. E.g. [Title](URL)
     ...
     When link is in LLM-friendly plain text format, include list of key headers and topics to clarify what does it cover.
   - `## Related Skills`:
